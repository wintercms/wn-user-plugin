<div data-control="toolbar">
    <a
        href="<?= Backend::url('winter/user/users/create') ?>"
        class="btn btn-primary oc-icon-plus">
        <?= e(trans('winter.user::lang.users.new_user')) ?>
    </a>
    ...
    <div class="btn-group dropdown dropdown-fixed" data-control="bulk-actions">
        ...
        <ul class="dropdown-menu" data-dropdown-title="<?= e(trans('winter.user::lang.users.bulk_actions')) ?>">
            ...
            <li>
                <a href="javascript:;" class="oc-icon-user-plus" data-action="restore" data-confirm="<?= e(trans('winter.user::lang.users.restore_selected_confirm')) ?>">
                    <?= e(trans('winter.user::lang.users.restore_selected')) ?>
                </a>
            </li>
            <li role="separator" class="divider"></li>
            <li>
                <a href="javascript:;" class="oc-icon-ban" data-action="ban" data-confirm="<?= e(trans('winter.user::lang.users.ban_selected_confirm')) ?>">
                    <?= e(trans('winter.user::lang.users.ban_selected')) ?>
                </a>
            </li>
            <li>
                <a href="javascript:;" class="oc-icon-circle-o-notch" data-action="unban" data-confirm="<?= e(trans('winter.user::lang.users.unban_selected_confirm')) ?>">
                    <?= e(trans('winter.user::lang.users.unban_selected')) ?>
                </a>
            </li>
        </ul>
    </div>
    ...
    <?=
        /**
         * @event winter.user.view.extendListToolbar
         * Fires when user list toolbar is rendered.
         *
         * Example usage:
         *
         *     Event::listen('winter.user.view.extendListToolbar', function (
         ...
         *
         */
        $this->fireViewEvent('winter.user.view.extendListToolbar');
    ?>
