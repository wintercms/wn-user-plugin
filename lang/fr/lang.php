...
return [
    ...
    'users' => [
        ...
        'unsuspend_confirm' => 'Débloquer l\'utilisateur ?'
    ],
    'settings' => [
        'users' => 'Utilisateurs',
        ...
        'use_register_throttle' => 'Temportiser l\'inscription',
        'use_register_throttle_comment' => 'Empêcher les enregistrements multiples à partir de la même adresse IP dans un court laps de temps.',
        ...
        'remember_login' => 'Mémoriser le mode de connexion',
        'remember_login_comment' => 'Indiquez si la session de l\'utilisateur doit être persistante.',
    ...
    'user' => [
        ...
        'created_ip_address' => 'Adresse IP utilisée',
    ...
    'account' => [
        ...
        'registration_throttled' => 'L\'inscription est bloquée. Veuillez réessayer plus tard.',
        'sign_in' => 'Connexion',
        ...
        'no_avatar' => 'Votre compte n\'a pas de photo d\'affichage à supprimer.',
