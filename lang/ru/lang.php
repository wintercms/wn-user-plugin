...
return [
    ...
    'reportwidgets' => [
        'statistics' => [
            ...
            'tooltip_registr_today' => 'Пользователей зарегистрированных сегодня',
            'tooltip_registr_yesterday' => 'Пользователей зарегистрированных за вчерашний день',
            'tooltip_registr_month' => 'Пользователей зарегистрированных за последний месяц',
            'tooltip_registr_year' => 'Пользователей зарегистрированных за последний год',
            'activity' => 'Активность',
            'tooltip_activity_today' => 'Активных пользователей за сегодняшний день',
            'tooltip_activity_yesterday' => 'Активных пользователей за вчерашний день',
            'tooltip_activity_month' => 'Активных пользователей за последний месяц',
            'tooltip_activity_year' => 'Активных пользователей за год',
        ],
    ],
];
